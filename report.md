...
- **A. Code.** The full project — `simulation.py` (CLI), `simulation.ipynb` (notebook), `memory.py` (associative memory + retrieval + reflection), and `agents/*.json` (agent identities) — is published at <https://github.com/baker-jr-john/educ5919-triangle-simulation>.
